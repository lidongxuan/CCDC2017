...
%   http://www.isr.uc.pt/~henriques/
	...
	try
        ...
        %if previous code returns errors, try this:
		frewind(f);%move pointer to the beginning of this file  
	...
	pos = [ground_truth(1,2), ground_truth(1,1)] + floor(target_sz/2);%floor:  make sure ans is int
